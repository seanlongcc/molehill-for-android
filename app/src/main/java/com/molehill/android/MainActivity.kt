...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //gain access to these views, set gatherData button to gatherData
        val gatherData = findViewById<Button>(R.id.gatherData)
        ...
        //when gatherData button has been clicked
        gatherData.setOnClickListener {
            //hide the button
            gatherData.visibility = View.GONE
